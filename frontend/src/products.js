const products = [
  ...
  },
  {
    ...
    description: 'Introducing the iPhone 13 Pro. A total leap forward in battery life. Ceramic Shield, tougher than any smartphone glass.',
    brand: 'Apple',
    category: 'Electronics',
    price: 599.99,
    countInStock: 7,
  ...
  {
    name: 'Logitech G-Series Wireless Gaming Mouse',
  ...
  },
  {
    ...
    description: 'Meet Echo Dot - Our most popular voice-controlled speaker, now with a fabric design and improved speaker for richer sound.',
    brand: 'Amazon',
    category: 'Electronics',
    price: 29.99,
    countInStock: 0,
